...
export default function Example() {
  return (
    <div className="bg-praimary">
      <header>
        <Popover className="relative bg-praimary">
          <div className="mx-auto flex max-w-7xl items-center justify-between py-6 px-6 md:justify-start md:space-x-10 lg:px-8">
            ...
            <div className="-my-2 -mr-2 md:hidden">
              <Popover.Button className="inline-flex items-center justify-center rounded-md bg-praimary p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
                ...
                <div className="py-6 px-5">
                  ...
                  <div className="mt-6">
                    ...
                    <p className="mt-6 text-center text-base font-medium text-gray-500">
                      Existing customer?
                      <a href="/SignInPage" className="text-gray-900">
                        Sign in
                      </a>
                    </p>
                  </div>
